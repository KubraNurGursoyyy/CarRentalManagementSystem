...
namespace CarRentalManagementSystem.Web.Controllers
{
    public class CompanyController : Controller
    {
       ...
       public static int companyid = 0;
        ...
        [Authorize]
        public ViewResult AddVehicleToCompanyView()
        {
            return View();
        }
       ...
       [HttpPost]
        ...
        {
            return View(ListAllEmployeesOfCompany());
        }
        [Authorize]
        public ViewResult SaveEmployeesToCompanyView()
        {
            return View();
        }
        [HttpPost]
        ...
        {
            return View(ListCompanysAllVehicles());
        }
        [Authorize]
        public ActionResult CompanysRentedVehiclesView()
        {
            return View(ListCompanysRentedVehicles());
        }
        [HttpPost]
        [Authorize]
        [ValidateAntiForgeryToken]
        ...
        private bool SaveEmployee(string email, string password, string phonenumber, string address)
        {
            try
            {
